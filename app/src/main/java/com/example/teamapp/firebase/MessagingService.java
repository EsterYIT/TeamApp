package com.example.teamapp.firebase;
...
public class MessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage message) {
        ...
        User user=new User();
        user.setId(message.getData().get("userId"));
        user.setUsername(message.getData().get("name"));
        user.setToken(message.getData().get("FCMToken"));
